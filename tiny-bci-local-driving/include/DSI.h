...
#define DSI_API_MINOR_VERSION 20  /*     values, to find out the version of the API that */
#define DSI_API_BUILD          4  /*     was used to compile your dynamic library.       */
...
DSI_API_FUNC(  void           ,    DSI_Headset_SetWatchdogInterval               ,  ( DSI_Headset h, double seconds )                                        ,   DO( HEADSET->SetWatchdogInterval( seconds ) )                                                                  )
