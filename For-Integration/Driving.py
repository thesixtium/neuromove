...
def main(driving_mode, gyroscope_data, destination, local_input):
    ...
    while driving_mode == 0:
        t_accel = 0.28 #in seconds, calculated
        t_const = 1.15 #in seconds, calculated
        t_rotaccel = 0.28 #in seconds, calculated w/ 1 estimated value
        t_rotconst = 0.77 #in seconds, calculated w/ 1 estimated value
